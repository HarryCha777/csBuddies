...
struct WelcomeAnimationView: View {
    ...
    let gradient: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color.blue, Color.red]), startPoint: .leading, endPoint: .trailing)
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                SmallImageView(userId: global.myId, isOnline: false, size: 160, myImage: global.bigImage)
                    .scaledToFit()
