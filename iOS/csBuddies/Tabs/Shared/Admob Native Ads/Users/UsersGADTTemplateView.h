...
typedef NSString* UsersGADTNativeTemplateStyleKey NS_STRING_ENUM;
...
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyCallToActionFont;

/// Call to action font  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyCallToActionFontColor;

/// Call to action background  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyCallToActionBackgroundColor;
...
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyPrimaryFont;

/// Primary text font  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyPrimaryFontColor;

/// Primary text background  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyPrimaryBackgroundColor;
...
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeySecondaryFont;

/// Secondary text font  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeySecondaryFontColor;

/// Secondary text background  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeySecondaryBackgroundColor;
...
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyTertiaryFont;

/// Tertiary text font  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyTertiaryFontColor;

/// Tertiary text background  Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyTertiaryBackgroundColor;

#pragma mark - Additional Style Options

/// The background color for the bulk of the ad. Expects a UI
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyMainBackgroundColor;

/// The corner rounding radius for the icon view and call to action. Expects an NSNumber.
extern UsersGADTNativeTemplateStyleKey const UsersGADTNativeTemplateStyleKeyCornerRadius;

/// The super class for every template object.
/// This class has the majority of all layout and styling logic.
@interface UsersGADTTemplateView : GADUnifiedNativeAdView
@property(nonatomic, copy) NSDictionary<UsersGADTNativeTemplateStyleKey, NSObject*>* styles;
